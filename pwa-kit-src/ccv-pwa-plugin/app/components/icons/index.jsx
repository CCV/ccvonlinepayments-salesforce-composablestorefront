...
import IdealFastSymbol from '../../assets/svg/ideal-fast-logo.svg'
...
IdealFastSymbol.viewBox = IdealFastSymbol.viewBox || '0 0 47 24'
...
export const IdealFastIcon = icon('ideal-fast-logo', {viewBox: IdealFastSymbol.viewBox})
