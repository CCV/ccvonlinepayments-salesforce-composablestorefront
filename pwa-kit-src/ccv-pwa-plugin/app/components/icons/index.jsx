...
// ==================== CCV ICONS ====================
import IdealWeroSymbol from '../../assets/svg/ideal-wero-logo.svg'
import IdealWeroSymbolWide from '../../assets/svg/ideal-wero-logo-wide.svg'
...
BancontactSymbol.viewBox = BancontactSymbol.viewBox || '0 0 1490 1080'
...
GooglePaySymbol.viewBox = GooglePaySymbol.viewBox || '0 0 754 400'
IdealWeroSymbol.viewBox = IdealWeroSymbol.viewBox || '0 0 295 295'
IdealWeroSymbolWide.viewBox = IdealWeroSymbolWide.viewBox || '0 0 480 182'
...
export const GooglePayIcon = icon('google-pay-logo', {viewBox: GooglePaySymbol.viewBox})
export const IdealWeroIcon = icon('ideal-wero-logo', {viewBox: IdealWeroSymbol.viewBox})
export const IdealWeroIconWide = icon('ideal-wero-logo-wide', {
    viewBox: IdealWeroSymbolWide.viewBox
})
