...
Order.ORDER_STATUS_NEW = 2;
Order.ORDER_STATUS_CANCELLED = 6;
Order.ORDER_STATUS_FAILED = 8;
Order.CONFIRMATION_STATUS_CONFIRMED = 2;
Order.EXPORT_STATUS_EXPORTED = 1;
Order.EXPORT_STATUS_READY = 2;
