...
const { execute } = proxyquire('../../cartridges/int_ccv/cartridge/scripts/jobs/processOrderEnrichments', {
    ...
    '*/cartridge/scripts/helpers/ccvOrderEnrichment': stubs.ccvOrderEnrichmentMock,
...
describe('processOrderEnrichments', function () {
    let enrichment;
    let order;
    ...
    beforeEach(() => {
        ...
        stubs.ccvOrderEnrichmentMock.getPending.returns(iteratorOf([enrichment]));
    ...
    it('should apply the consumer details and remove the record', () => {
        ...
        expect(stubs.ccvOrderEnrichmentMock.remove).to.have.been.calledOnceWith(enrichment);
    ...
    it('should keep the record queued when CCV still has no consumer data', () => {
        ...
        expect(stubs.ccvOrderEnrichmentMock.remove).to.not.have.been.called;
    ...
    it('should give up once the maximum number of attempts is reached', () => {
        enrichment.custom.attempts = stubs.ccvOrderEnrichmentMock.MAX_ATTEMPTS - 1;
        stubs.CCVOrderHelpersMock.addAddressDetails.returns(false);
    ...
    it('should close the query iterator', () => {
        ...
        stubs.ccvOrderEnrichmentMock.getPending.returns(iterator);
